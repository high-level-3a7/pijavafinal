...
public class Acceuil2Controller implements Initializable {
    ...
    @FXML
    private void getintadmin(MouseEvent event) throws IOException {
    ...
    @FXML
    private void getintclient(MouseEvent event) throws IOException {
    ...
    private void retour(MouseEvent event) throws IOException {
        Parent parentacc2 = FXMLLoader.load(getClass().getResource("/gui1/acceuil.fxml"));
            Scene sceneacc2 = new Scene(parentacc2);
            Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            stage.setScene(sceneacc2);
            stage.show();
