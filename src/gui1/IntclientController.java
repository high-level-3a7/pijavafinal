...
public class IntclientController implements Initializable {
    ...
    @FXML
    private void consutousreclamations(MouseEvent event) throws IOException {
        
        Parent parentacc2 = FXMLLoader.load(getClass().getResource("/gui1/intreclamation2.fxml"));
    ...
    @FXML
    private void consulterrecbyid(MouseEvent event) throws IOException {
