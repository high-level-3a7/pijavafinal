...
public class IntadminController implements Initializable {
    ...
    @FXML
    private void getActinterface(MouseEvent event) throws IOException {
    ...
    @FXML
    private void getrecinterface(MouseEvent event) throws IOException {
        
        Parent parentacc2 = FXMLLoader.load(getClass().getResource("/gui1/intreclamation.fxml"));
            Scene sceneacc2 = new Scene(parentacc2);
            Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            stage.setScene(sceneacc2);
            stage.show();
    ...
    @FXML
    private void gettypeactinterface(MouseEvent event) throws IOException {
    ...
    @FXML
    private void gettyperecinterface(MouseEvent event) throws IOException {
    ...
    @FXML
    private void getetatrecinterface(MouseEvent event) throws IOException {
    ...
    @FXML
    private void gogesmat(MouseEvent event) throws IOException {
