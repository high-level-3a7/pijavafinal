 ...
 * @author karbo
 */
public class TypeactiviteController implements Initializable {
    ...
    private void getAddactint(MouseEvent event) throws IOException {
        ...
        Parent parentacc2 = FXMLLoader.load(getClass().getResource("/gui1/addtypeactivite.fxml"));
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/gui1/modiftypeactivite.fxml"));
                            try {
                                loader.load();
